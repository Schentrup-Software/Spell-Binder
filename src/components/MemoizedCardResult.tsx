...
const MemoizedCardResult = memo(function CardResult({ card, onClick }: CardResultProps) {
  ...
  return (
    ...
    prevProps.card.price_usd === nextProps.card.price_usd &&
    prevProps.onClick === nextProps.onClick
  );
});

export default MemoizedCardResult;